...
class Hive(models.Model):
    ...
    loc_lat=models.DecimalField(max_digits=8, decimal_places=6, blank=True, null=True)
    loc_long=models.DecimalField(max_digits=8, decimal_places=6, blank=True, null=True)
